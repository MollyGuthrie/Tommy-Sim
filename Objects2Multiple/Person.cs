...
namespace Objects2Multiple
{
    class Person
    {
        ...
        public void Work()
        {
            ...
            Console.WriteLine("6) Food (find food)");
            Console.WriteLine("7) Build a castle (Requires 20 wood)");
        ...
        public void findFood()
        {
            ...
            Console.WriteLine(name + " found " + amount + " units of food");
        ...
        {
            string[] resources = { "wood", "water", "watersource","nothing","death","food" };
        ...
        public bool Eat()
        {
            ...
            if (homeCity.food > 0)
            {
                survive = true;
                homeCity.food--;
                Console.WriteLine(name + " ate 1 food unit");
            }
            else
            {
                survive = false;
